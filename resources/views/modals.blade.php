    ...
    <div class="modal-dialog" role="document">
        <form class="modal-content new-form-submit-event" action="{{ url('status/store') }}" method="POST">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col mb-3">
                        <label for="type" class="form-label"><?= get_label('type', 'Type') ?> <span
                                class="asterisk">*</span></label>
                        <select class="form-select js-example-basic-multiple" id="type" name="type[]" multiple="multiple" data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>" required>
                            <option value="task"><?= get_label('task', 'Task') ?></option>
                            <option value="subtask"><?= get_label('sub_task', 'Sub Task') ?></option>
        ...
        <div class="modal-dialog" role="document">
            <form action="{{ url('status/update') }}" class="modal-content form-submit-event" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            <label for="edit_status_type" class="form-label"><?= get_label('type', 'Type') ?> <span
                                    class="asterisk">*</span></label>
                            <select class="form-select js-example-basic-multiple" id="edit_status_type" name="type[]" multiple="multiple" data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>" required>
                                <option value="task"><?= get_label('task', 'Task') ?></option>
                                <option value="subtask"><?= get_label('sub_task', 'Sub Task') ?></option>
                                <option value="project"><?= get_label('project', 'Project') ?></option>
                            </select>
            ...
            <form class="modal-content form-submit-event" action="{{ url('contracts/store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <label class="form-label"
                            for=""><?= get_label('select_user', 'Select User') ?> <span
                                class="asterisk">*</span></label>
                        <div class="col-12 mb-3">
                        ...
                        <label class="form-label" for="division_id"><?= get_label('division', 'Division') ?></label>
                        <div class="col-12 mb-3">
                            <select class="form-select text-capitalize" name="division_id" data-placeholder="<?= get_label('please_select', 'Please select') ?>" data-allow-clear="true">
                                <option value=""><?= get_label('please_select', 'Please select') ?></option>
                                @foreach ($divisions as $division)
                                <option value="{{$division->id}}">{{ ucfirst($division->title) }}</option>
                                @endforeach
                            </select>
                        </div>
                        <label class="form-label"
                    ...
                    <div class="row">
                        ...
                        <label class="form-label"
                            for=""><?= get_label('select_user', 'Select User') ?> <span
                                class="asterisk">*</span></label>
                        <div class="col-12 mb-3">
                            <select class="form-select users_select" id="user_id" name="user_id"
                                data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>"
                                data-allow-clear="false" data-single-select="true">
                            </select>
                        </div>
                        <label class="form-label" for="division_id"><?= get_label('division', 'Division') ?></label>
                        <div class="col-12 mb-3">
                            <select class="form-select text-capitalize" id="division_id_edit" name="division_id" data-placeholder="<?= get_label('please_select', 'Please select') ?>" data-allow-clear="true">
                                <option value=""><?= get_label('please_select', 'Please select') ?></option>
                                @foreach ($divisions as $division)
                                <option value="{{$division->id}}">{{ ucfirst($division->title) }}</option>
                                @endforeach
...
@endif
    <div class="modal fade" id="create_division_modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <form class="modal-content form-submit-event" action="{{ url('divisions/store') }}" method="POST">
                <input type="hidden" name="dnr">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1"><?= get_label('create_division', 'Create division') ?>
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
    ...
    <div class="modal fade" id="edit_division_modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <form class="modal-content form-submit-event" action="{{ url('divisions/update') }}" method="POST">
                <input type="hidden" name="dnr">
                <input type="hidden" id="division_id" name="id">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1"><?= get_label('update_division', 'Update division') ?>
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for="nameBasic" class="form-label"><?= get_label('title', 'Title') ?> <span
                                    class="asterisk">*</span></label>
                            <input type="text" class="form-control" id="division_title" name="title"
                                placeholder="<?= get_label('please_enter_title', 'Please enter title') ?>" />
                        </div>
                    </div>
                </div>
...
@if (Request::is('settings/sms-gateway'))
    ...
    <div class="modal fade" id="testTelegramSettingsModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        {{ get_label('test_telegram_notification_settings', 'Test Telegram Notification Settings') }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <form id="testTelegramSettingsForm">
                    <div class="modal-body">
                        <small
                            class="text-muted">{{ get_label('test_telegram_notification_settings_info', 'This is where you can test your Telegram notification settings. Before testing, please update the settings if they haven\'t been updated already.') }}</small>
                        <div class="my-3">
                            <label class="form-label">{{ get_label('recipient_chat_id', 'Recipient Chat ID') }} <span
                                    class="asterisk">*</span></label>
                            <input type="text" class="form-control" id="testTelegramChatId" required>
                        </div>
                        <div class="mb-3">
                            <label for="testTelegramMessage" class="form-label">{{ get_label('message', 'Message') }}
                                <span class="asterisk">*</span></label>
                            <textarea class="form-control" id="testTelegramMessage" rows="3" required></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">
                        ...
                        <button type="submit" class="btn btn-primary"
                            id="performTestTelegramSettingsButton">{{ get_label('submit', 'Submit') }}</button>
                    </div>
                    <div id="telegramTestResponse" class="d-none">
                        <div class="modal-body">
                            <h5>{{ get_label('response', 'Response') }}:</h5>
                            <pre id="telegramResponseText"></pre>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <form method="POST" id="updateCandidateForm" class="form-submit-event">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body row g-3">
                    ...
                    <div class="col-md-6">
                        <label for="division_id" class="form-label">{{ get_label('division', 'Division') }}</label>
                        <select class="form-select" name="division_id" id="candidateDivisionId">
                            <option value="">{{ get_label('select_division', 'Select Division') }}</option>
                            @foreach ($divisions as $division)
                                <option value="{{ $division->id }}">{{ ucfirst($division->title) }}</option>
                            @endforeach
