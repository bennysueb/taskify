    ...
    <div class="card">
        <div class="card-body">
            <div class="list-group list-group-horizontal-md text-md-center">
                ...
                <a class="list-group-item list-group-item-action" data-bs-toggle="list" href="#telegram-settings"><?= get_label('telegram', 'Telegram') ?></a>
            </div>
            <div class="tab-content px-0">
                ...
                @endphp
                <div class="tab-pane fade show" id="telegram-settings">
                    <div class="alert alert-primary" role="alert">
                        <?= get_label('important_settings_for_telegram_notification_feature_to_be_work', 'Important settings for Telegram notification feature to be work.') ?>
                        <a href="javascript:void(0)" data-bs-toggle="modal"
                            data-bs-target="#telegram_instruction_modal"><?= get_label('click_for_help', 'Click here for help.') ?></a>
                    </div>
                    <form action="{{ url('/settings/store_telegram') }}" class="form-submit-event" method="POST">
                        <input type="hidden" name="dnr">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="telegram_bot_token"
                                    class="form-label">{{ get_label('telegram_bot_token', 'Telegram Bot Token') }}
                                    <span class="asterisk">*</span></label>
                                <input type="text" class="form-control" name="telegram_bot_token"
                                    value="{{ $telegram_settings['telegram_bot_token'] ?? '' }}"
                                    placeholder="{{ get_label('telegram_bot_token', 'Telegram Bot Token') }}">
                            </div>
                        </div>
                        <div class="mt-2">
                            <button type="submit" class="btn btn-primary me-2"
                            ...
                            <button type="reset"
                                class="btn btn-outline-secondary"><?= get_label('cancel', 'Cancel') ?></button>
                            @if (config('constants.ALLOW_MODIFICATION') === 1)
                            <button type="button" class="btn btn-success me-2" id="testTelegramSettingsButton"><?= get_label('send_test_message', 'Send Test Message') ?></button>
                            @endif
                        </div>
                    </form>
                </div>
...
<div class="modal fade" id="telegram_instruction_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel3">
                    <?= get_label('telegram_bot_configuration', 'Telegram Bot Configuration') ?>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <h6>Steps for Telegram Bot Token Setup:</h6>
                <ol>
                    <li>
                        <strong>Create a Telegram Bot:</strong>
                        <ol type="a">
                            <li>Open Telegram and search for <strong>@BotFather</strong>.</li>
                            <li>Start a chat with BotFather and click "Start".</li>
                    ...
                    <li>
                        <strong>Get your Bot Token:</strong>
                        <ol type="a">
                            <li>Once the bot is created, BotFather will send you a message with your <strong>API Token</strong>.</li>
                            <li>Copy this token and paste it into the "Telegram Bot Token" field above.</li>
                        </ol>
                    </li>
                    <li>
                        <strong>Get User Chat ID (For Users):</strong>
                        <ol type="a">
                            <li>Users must start a chat with your new bot.</li>
                            <li>You can use tools like <strong>@userinfobot</strong> to find your numeric Chat ID, or you can implement a webhook to capture it automatically (Requires advanced setup).</li>
                            <li>For this integration, ensure users update their profile with their Telegram Chat ID.</li>
                        </ol>
                    </li>
                </ol>
                <div class="alert alert-warning" role="alert">
                    <strong>Important:</strong> Keep your Bot Token confidential. Do not share it publicly.
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">
