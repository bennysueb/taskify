...
class PayslipsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $divisions = Division::where('workspace_id', $this->workspace->id)->get();
        return view('payslips.list', ['payslips' => $payslips, 'divisions' => $divisions]);
    }
    ...
    public function create(Request $request)
    {
        ...
        $divisions = Division::where('workspace_id', $this->workspace->id)->get();
        return view('payslips.create', ['users' => $users, 'payment_methods' => $payment_methods, 'divisions' => $divisions]);
    }
    ...
    public function list()
    {
        ...
        if (!empty($division_ids)) {
            $payslips->whereIn('payslips.division_id', $division_ids);
        }
        ...
        $payslips = $payslips->orderBy($sort, $order)
            ...
            ->through(function ($payslip) use ($canEdit, $canDelete, $canCreate) {
                ...
                return [
                    ...
                    'division' => $payslip->division ? ucfirst($payslip->division->title) : '-',
    ...
    public function edit(Request $request, $id)
    {
        ...
        $payment_methods = $this->workspace->payment_methods;
        $divisions = Division::where('workspace_id', $this->workspace->id)->get();
        return view('payslips.update', ['payslip' => $payslip, 'users' => $users, 'payment_methods' => $payment_methods, 'divisions' => $divisions]);
    }
