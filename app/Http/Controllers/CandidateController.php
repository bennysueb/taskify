...
class CandidateController extends Controller
{
  public function index()
  {
    ...
    return view('candidate.index', compact('statuses', 'candidates', 'divisions'));
  }
  ...
  public function list()
  {
    ...
    $query = Candidate::with(['status', 'division']);
    ...
    ';
        ...
        'name' => "<a href='" . route('candidate.show', ['id' => $candidate->id]) . "' >" . ucwords($candidate->name) . "</a>",
          ...
          'division' => $candidate->division ? ucfirst($candidate->division->title) : '-',
