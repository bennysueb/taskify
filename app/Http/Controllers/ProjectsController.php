...
class ProjectsController extends Controller
{
    ...
    public function index(Request $request, $type = null)
    {
        ...
        $statuses = Status::where('type', 'like', '%project%')->get();
    ...
    public function kanban_view(Request $request, $type = null)
    {
        ...
        $customFields = CustomField::where('module', 'project')->get();
        $projectStatuses = Status::where('type', 'like', '%project%')->get();
        return view('projects.kanban', ['projects' => $projects, 'auth_user' => $this->user, 'selectedTags' => $selectedTags, 'is_favorite' => $is_favorite, 'customFields' => $customFields, 'statuses' => $projectStatuses]);
    }
    public function list_view(Request $request, $type = null)
    {
        ...
        $statuses = Status::where('type', 'like', '%project%')->get();
        return view('projects.projects', ['projects' => $projects, 'is_favorites' => $is_favorites, 'customFields' => $customFields, 'statuses' => $statuses]);
    }
    public function ganttChartView(Request $request, $type = null)
    {
        ...
        $statuses = Status::where('type', 'like', '%project%')->get();
        return view('projects.gantt_chart', ['is_favorite' => $is_favorite, 'customFields' => $customFields, 'statuses' => $statuses]);
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (canSetStatus($status, 'project')) {
