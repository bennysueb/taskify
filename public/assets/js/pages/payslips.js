...
addDebouncedEventListener('#status_filter, #user_filter, #division_filter, #user_creators_filter, #client_creators_filter, #filter_payslip_month', 'change', function (e, refreshTable) {
    e.preventDefault();
...
$(document).on('click', '.clear-payslips-filters', function (e) {
    ...
    $('#division_filter').val('').trigger('change', [0]);
