...
$(document).on("click", ".edit-status", function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var types = response.status.type.split(',');
            $("#edit_status_type").val(types).trigger('change');
            $("#status_color")
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.error == false) {
                ...
                $("#division_id_edit").val(response.contract.division_id).trigger('change');
...
$(document).on("click", "#testTelegramSettingsButton", function (e) {
    e.preventDefault();
    $("#testTelegramSettingsModal").modal("show");
});
$("#testTelegramSettingsForm").on("submit", function (event) {
    event.preventDefault();
    var telegramChatId = $("#testTelegramChatId").val();
    var message = $("#testTelegramMessage").val();
    // AJAX request
    $.ajax({
        url: baseUrl + "/settings/notifications/test",
        method: "POST",
        ...
        dataType: "json",
        beforeSend: function () {
            $("#performTestTelegramSettingsButton")
                .prop("disabled", true)
                .html(label_sending);
        },
        success: function (response) {
            ...
            $("#performTestTelegramSettingsButton")
                .prop("disabled", false)
                .html(label_submit);
            $("#telegramTestResponse").removeClass("d-none");
            $("#telegramResponseText").text(JSON.stringify(response, null, 2));
        },
        error: function (xhr, status, error) {
            // Handle error
            $("#performTestTelegramSettingsButton")
                ...
                .html(label_submit);
            $("#telegramTestResponse").removeClass("d-none");
            $("#telegramResponseText").text("Error: " + xhr.responseText);
        },
    });
});
$("#testTelegramSettingsModal").on("hidden.bs.modal", function () {
    $("#telegramTestResponse").addClass("d-none");
    $("#telegramResponseText").text("");
});
$(document).ready(function () {
