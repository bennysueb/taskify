...
Route::middleware(['CheckInstallation'])->group(function () {
    ...
    Route::middleware(['multiguard', 'custom-verified', 'system.check'])->group(function () {
        ...
        Route::middleware(['customRole:admin'])->group(function () {
            ...
            Route::post('/settings/email/test', [SettingsController::class, 'send_test_email'])->middleware(['demo_restriction']);
            ...
            Route::put('/settings/store_telegram', [SettingsController::class, 'store_telegram_settings'])->middleware(['demo_restriction']);
        ...
        Route::middleware(['has_workspace'])->group(function () {
            ...
            Route::middleware(['customcan:manage_divisions'])->group(function () {
                Route::get('/divisions', [DivisionsController::class, 'index'])->name('divisions.index');
                Route::post('/divisions/store', [DivisionsController::class, 'store'])->middleware(['customcan:create_divisions', 'log.activity']);
                Route::get('/divisions/list', [DivisionsController::class, 'list']);
                Route::get('/divisions/get/{id}', [DivisionsController::class, 'get']);
                Route::put('/divisions/update', [DivisionsController::class, 'update'])->middleware(['customcan:edit_divisions', 'log.activity']);
                Route::delete('/divisions/destroy/{id}', [DivisionsController::class, 'destroy'])->middleware(['customcan:delete_divisions', 'demo_restriction', 'log.activity']);
                Route::post('/divisions/destroy_multiple', [DivisionsController::class, 'destroy_multiple'])->middleware(['customcan:delete_divisions', 'demo_restriction', 'log.activity']);
            });
            ...
            // Divisions Routes
            Route::group(['middleware' => ['has_workspace']], function () {
                Route::get('/divisions', [DivisionsController::class, 'index']);
                Route::post('/divisions/store', [DivisionsController::class, 'store']); // Add permission if needed
                Route::get('/divisions/get/{id}', [DivisionsController::class, 'get']);
                Route::get('/divisions/list', [DivisionsController::class, 'list']);
                Route::post('/divisions/update', [DivisionsController::class, 'update']);
                Route::delete('/divisions/destroy/{id}', [DivisionsController::class, 'destroy']);
                Route::post('/divisions/destroy_multiple', [DivisionsController::class, 'destroy_multiple']);
            });
